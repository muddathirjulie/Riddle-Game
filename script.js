const riddles = [
    ...
    function checkAnswer() {
      ...
      if (guess === currentRiddle.answer) {
        ...
        wrongAttempts++;
        if (wrongAttempts === 3) {
          resultElement.textContent = `Incorrect! The answer is ${currentRiddle.answer}. Moving on.`;
          setTimeout(function() {
            nextRiddle();
          }, 3000);
        }
    ...
    function nextRiddle() {
      ...
      if (currentRiddleIndex < riddles.length) {
        ...
        document.getElementById('riddle-container').innerHTML += "<p>Your score: " + correctAttempts + " out of " + riddles.length + "</p>";
      }
    }
